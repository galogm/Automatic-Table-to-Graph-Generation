...
from garc.models.autog.agent import load_dbb_dataset_from_cfg_path_no_name
from garc.models.autom.agent import AutoM_Agent
from garc.prompts.autom_task import get_task_description
...
def main(
    ...
    task_description = get_task_description(
        dataset, task_name, target_column, target_table, primary_column
    )
