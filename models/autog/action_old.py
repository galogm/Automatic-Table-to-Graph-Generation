...
def connect_two_columns(table_1_name, table_1_col_name, table_2_name, table_2_col_name, new_table_name="", new_table_col_name=""):
    """
        Description:
...
def explode_multi_category_column(original_table, multi_cat_col, primary_key_column, new_table_name, new_col_name, dtype):
    """
        Description:
