...
def get_multi_round_action_selection_prompt_epoch(
    actions, example, history_actions, input_schema, stats, task, jtd
):
    MULTI_ROUND = """
...
def get_multi_round_action_selection_prompt(
    actions, example, history_actions, input_schema, stats, task, jtd
):
    MULTI_ROUND = """
        Imagine you are an expert graph data scientist, and now you are expected to construct graph schema based on the original
